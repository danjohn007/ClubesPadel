    ...
    <div class="row">
        ...
        <div class="col-12 p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="bi bi-arrow-down-circle text-success"></i> Registrar Ingreso</h2>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="<?php echo URL_BASE; ?>/finances/createIncome">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="category_id" name="category_id" required>
                                ...
                                <?php else: ?>
                                    ...
                                    <option value="2">Membresías</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" 
                                      placeholder="Detalles adicionales del ingreso"></textarea>
                        </div>
