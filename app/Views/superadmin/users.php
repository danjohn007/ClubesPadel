...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-3 col-lg-2 p-0">
            <div class="sidebar p-3">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="<?php echo URL_BASE; ?>/superadmin/users">
        ...
        <div class="col-md-9 col-lg-10 p-4">
            <h2><i class="bi bi-people"></i> CRM Usuarios</h2>
            <p class="text-muted mb-4">Gestión centralizada de todos los usuarios del sistema</p>
                                ...
                                <tbody>
                                    <?php foreach ($users as $user): ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($user['club_name'] ?? 'SuperAdmin'); ?></td>
