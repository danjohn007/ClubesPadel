...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-3 col-lg-2 p-0">
            <div class="sidebar p-3">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="<?php echo URL_BASE; ?>/superadmin/sponsors">
        ...
        <div class="col-md-9 col-lg-10 p-4">
            <h2><i class="bi bi-briefcase"></i> Patrocinadores</h2>
            <p class="text-muted mb-4">Gestión de patrocinadores y alianzas comerciales</p>
            
            <div class="alert alert-info">
                <i class="bi bi-info-circle"></i> Módulo en desarrollo. Próximamente podrás gestionar patrocinadores y sus inversiones.
            </div>
            
            <div class="card">
                <div class="card-body">
                    <p class="text-muted text-center py-5">
                        <i class="bi bi-briefcase" style="font-size: 3rem;"></i><br>
